...
#Output rewards dictionaries to .csv files
df = pd.DataFrame.from_dict(noderewards, orient="index")
df.to_csv("NodeRewards.csv")
df = pd.DataFrame.from_dict(minerrewards, orient="index")
df.to_csv("MinerRewards.csv")
df = pd.DataFrame.from_dict(citizenrewards, orient="index")
df.to_csv("CitizenRewards.csv")